...
/* 
    Se volessimo unire più stringhe tra loro, possiamo usare quella che si chiama concatenazione (concatenation) e per farlo usiamo l'operatore di concatenazione +
*/
...
// console.log(strEs.split("").reverse().join(""));
...
// Non molto corretto, perché se il nomde del file contenesse più punti, non funzionerebbe
// console.log(immagine.split(".")[1]);

// Corretto perché non dipende dal numero di punti, visto che va a cercare l'ultimo punto
